    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card p-3">
                        <div class="card-header"><h3>{{ __('Brands')}}</h3></div>
                        <div class="card-body">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editUnitModalLabel">Edit Brand</h5>
            ...
            <div class="modal-body">
                <form id="updateForm">
                    ...
                    <div class="form-group">
                        <label for="editShortName">Description</label>
...
<div class="modal fade edit-layout-modal pr-0 " id="categoryAdd" tabindex="-1" role="dialog" aria-labelledby="categoryAddLabel" aria-hidden="true">
    <div class="modal-dialog w-300" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="categoryAddLabel">{{ __('Add Brand')}}</h5>
            ...
            <div class="modal-body">
                <form id="submitForm">
                    ...
                    <div class="form-group">
                        <label class="d-block">Brand Details</label>
...
<script>
  ...
  $(document).ready(function() {
    handleFormSubmit('#submitForm', '{{ route('brands.store') }}','POST', function(response) {
...
$(document).ready(function() {
  ...
  $(document).ready(function() {
    handleDeleteAction('.deleteBtn', '/products/brands/delete', function(response) {
      console.log(response);
    }, function(error) {
      //console.error(error);
    });    
