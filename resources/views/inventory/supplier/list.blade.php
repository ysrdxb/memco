...
<div class="container-fluid">
    ...
    <div class="header-dashboard-clean">
        <div class="d-flex align-items-center mb-3 mb-md-0">
            ...
            <div>
                <h3 class="header-title-text-clean">{{ __('Suppliers')}}</h3>
                <p class="header-sub-text-clean">{{ __('List of Suppliers')}}</p>
            </div>
        </div>
        <div class="d-flex align-items-center" style="gap: 12px;">
            <a href="#categoryAdd" data-toggle="modal" data-target="#categoryAdd" class="btn btn-sm btn-primary-memco-memco"><i class="ik ik-plus"></i>Create</a>
