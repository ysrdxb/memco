    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editUnitModalLabel">Edit Category</h5>
            ...
            <div class="modal-body">
                <form id="updateForm">
                    ...
                    <div class="form-group">
                        <label for="editShortName">Code</label>
...
<script>
  ...
  $(document).ready(function() {
    handleFormSubmit('#submitForm', '{{ route('categories.store') }}','POST', function(response) {
      //console.log(response);
    }, function(error) {
      console.error(error);
    });
  ...
  $(document).ready(function() {
    handleDeleteAction('.deleteBtn', '/products/categories/delete', function(response) {
      console.log(response);
    }, function(error) {
      //console.error(error);
    });    
