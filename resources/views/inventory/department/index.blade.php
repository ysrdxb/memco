...
<div class="container-fluid">
			...
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						...
						<span>{{ __('List of departments')}}</span>
					</div>
				</div>
			</div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card p-3">
                <div class="card-header"><h3>{{ __('Departments')}}</h3></div>
                <div class="card-body">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editUnitModalLabel">Edit Department</h5>
...
<div class="modal fade edit-layout-modal pr-0 " id="categoryAdd" tabindex="-1" role="dialog" aria-labelledby="categoryAddLabel" aria-hidden="true">
    <div class="modal-dialog w-300" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="categoryAddLabel">{{ __('Add Department')}}</h5>
...
<script>
  ...
  $(document).ready(function() {
    handleFormSubmit('#submitForm', '{{ route('departments.store') }}','POST', function(response) {
      //console.log(response);
    }, function(error) {
      console.error(error);
    });
  ...
  $(document).ready(function() {
    handleDeleteAction('.deleteBtn', '/departments/delete', function(response) {
      console.log(response);
    }, function(error) {
      //console.error(error);
    });    
