            ...
            <div class="card">
                <div class="card-header row">
                    <div class="col col-sm-2">
                        <a href="{{url('budget-planner/create')}}" class="btn btn-sm btn-primary btn-rounded">Add Plan </a>
                    </div>
                    ...
                    <table id="advanced_table" class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>2023</td>
                                <td>
                                    <a href="{{url('budget-planner/edit/1')}}"><i class="ik ik-edit f-16 mr-15 text-green"></i></a>
                            ...
                            <tr>
                                ...
                                <td>2023</td>
                                <td>
                                    <a href="{{url('budget-planner/edit/2')}}"><i class="ik ik-edit f-16 mr-15 text-green"></i></a>
                                    <a href="#!"><i class="ik ik-trash-2 f-16 text-red"></i></a>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>2022</td>
                                <td>
                                    <a href="{{url('budget-planner/edit/3')}}"><i class="ik ik-edit f-16 mr-15 text-green"></i></a>
                                    <a href="#!"><i class="ik ik-trash-2 f-16 text-red"></i></a>
                                </td>
                            </tr>
                        </tbody>
