                ...
                <div class="card-body">
                    <div class="salestable">
                        <table class="table">
                            ...
                            <tbody>
                                <tr class="base-tr">
                                    <td class="pl-0"><input type="text" name="item" class="form-control hm-30"></td>
                                    <td><input type="text" name="quantity" class="form-control w-60 text-center hm-30"> </td>
                                    <td><input type="text" name="unit_price" class="form-control  hm-30"></td>
                                    <td><input type="text" name="discount" class="form-control w-60 text-center hm-30"></td>
