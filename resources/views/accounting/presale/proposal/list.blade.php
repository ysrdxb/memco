            ...
            <div class="card">
                <div class="card-header row">
                    <div class="col col-sm-2">
                        <a href="{{url('presale/proposal/create')}}" class="btn btn-sm btn-primary btn-rounded">Add Proposal </a>
                    </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{url('presale/proposal/edit/1')}}"><i class="ik ik-edit f-16 mr-15 text-green"></i></a>
