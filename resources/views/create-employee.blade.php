                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="phone" type="number" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" placeholder="Enter phone" required>
                                        <div class="help-block with-errors" ></div>
                                    ...
                                    <div class="form-group">
                                        <label for="email">{{ __('Employee No')}}<span class="text-red">*</span></label>
                                        <input id="employee_no" type="number" class="form-control @error('employee_no') is-invalid @enderror" name="employee_no" value="" placeholder="Enter Employee No" required>
                                        <div class="help-block with-errors" ></div>
